...
triple corner_2 = (0, r, h);
triple corner_3 = (r, 0, h);
triple corner_4 = (0, -r, h);
...
triple generator_4 = lambda_4 * unit(corner_4);
...
draw (corner_1 -- corner_2 -- corner_3 -- corner_4 -- corner_1, dashed);

draw ((0,0,0) -- corner_1, dashed);
draw ((0,0,0) -- corner_2, dashed);
draw ((0,0,0) -- corner_3, dashed);
draw ((0,0,0) -- corner_4, dashed);
...
draw (Label("$" + (string) lambda_4 + "\genvector_{i,4}$", EndPoint), (0,0,0) -- generator_4, Arrow3(DefaultHead2));

draw (Label("$\force_i$"), (0,0,0) -- generator_1 + generator_2 + generator_3 + generator_4, Arrow3(DefaultHead2));
